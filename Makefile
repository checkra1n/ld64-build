...
LINUX_ARM64_XAR_FLAGS                   := --host=arm-linux-gnu CFLAGS='$(LINUX_ARM64_XAR_CC_FLAGS)' CPPFLAGS='$(LINUX_ARM64_XAR_CC_FLAGS)' LDFLAGS='$(LINUX_ARM64_XAR_LD_FLAGS)' $(LINUX_XAR_FLAGS) ac_cv_path_XML2_CONFIG='$(LINUX_ARM64_SDK)/usr/bin/xml2-config --prefix=$(LINUX_ARM64_SDK)/usr'
